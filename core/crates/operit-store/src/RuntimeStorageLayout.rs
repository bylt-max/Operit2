...
pub const EXTENSIONS_PLUGIN_CONFIGS_DIR_PATH: &str = "runtime/extensions/plugins/configs";
pub const EXTENSIONS_MCP_DIR_PATH: &str = "runtime/extensions/mcp";

pub const RUNTIME_CLEAN_ON_EXIT_DIR_PATH: &str = "runtime/temp/clean_on_exit";
